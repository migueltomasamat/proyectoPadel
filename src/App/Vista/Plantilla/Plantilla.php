...
class Plantilla
{
    ...
    public function __construct(string $titulo="Sin titulo",string $dirLogotipo='/App/Vista/Plantilla/assets/img/logo.png' ,
    ...
    public function generarEncabezadoHTML($titulo): void
    {
        $this->setEncabezado("
                ...
                <head>
                    ...
                    <link href='/App/Vista/Plantilla/assets/css/bootstrap.css' rel='stylesheet' />
                    <!-- FONT AWESOME CSS -->
                    <link href='/App/Vista/Plantilla/assets/css/font-awesome.min.css' rel='stylesheet' />
                     <!-- STYLE SWITCHER  CSS -->
                    <link href='/App/Vista/Plantilla/assets/css/styleSwitcher.css' rel='stylesheet' />
                    <!-- CUSTOM STYLE CSS -->
                    <link href='/App/Vista/Plantilla/assets/css/style.css' rel='stylesheet' />  
                     <!--GREEN STYLE VERSION IS BY DEFAULT, USE ANY ONE STYLESHEET FROM TWO STYLESHEETS (green or red) HERE-->
                     <link href='/App/Vista/Plantilla/assets/css/themes/green.css' id='mainCSS' rel='stylesheet' />   
                  <!-- Google	Fonts -->
                ...
                <div class='container'>
                    ...
                    <div class='row ' >
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the left after 0.2s' >
                            <img src='/App/Vista/Plantilla/assets/img/1.jpg' class='img-rounded img-responsive' alt=''  />
                        ...
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the bottom after 0.4s' >
                            <img src='/App/Vista/Plantilla/assets/img/2.jpg' class='img-rounded img-responsive' alt=''  />
                        ...
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the right after 0.2s' >
                            <img src='/App/Vista/Plantilla/assets/img/3.jpg' class='img-rounded img-responsive' alt=''  />
