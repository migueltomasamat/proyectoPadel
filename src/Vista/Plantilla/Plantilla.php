...
class Plantilla
{
    ...
    public function __construct(string $titulo="Sin titulo",string $dirLogotipo='/Vista/Plantilla/assets/img/logo.png' ,
                ...
                <div class='container'>
                    ...
                    <div class='row ' >
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the left after 0.2s' >
                            <img src='Vista/Plantilla/assets/img/1.jpg' class='img-rounded img-responsive' alt=''  />
                        ...
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the bottom after 0.4s' >
                            <img src='Vista/Plantilla/assets/img/2.jpg' class='img-rounded img-responsive' alt=''  />
                        ...
                        <div class='col-lg-4 col-md-4 col-sm-4' data-scroll-reveal='enter from the right after 0.2s' >
                            <img src='Vista/Plantilla/assets/img/3.jpg' class='img-rounded img-responsive' alt=''  />
