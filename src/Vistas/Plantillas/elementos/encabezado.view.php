...
<head>
    ...
    <!-- STYLE SWITCHER  CSS -->
    <link href='plantilla/assets/css/styleSwitcher.css' rel='stylesheet' />
    <!-- CUSTOM STYLE CSS -->
    ...
    <link href='plantilla/assets/css/themes/green.css' id='mainCSS' rel='stylesheet' />
    <!-- Google	Fonts -->
...
<div class='navbar navbar-inverse navbar-fixed-top move-me' id='menu'>
    <div class='container'>
        <div class='navbar-header'>
            ...
            <a class='navbar-brand' href='index.php'><img class='logo-custom' src='plantilla/assets/img/logo180-50.png' alt='logo discosis'  /></a>
        </div>
